...
var TRANSLATIONS = {
  en: {
    ...
    prod_trio_name: "Haircare Trio Offer",
    prod_trio_desc: "The ultimate nourishing trio for gorgeous hair. Includes the Soft Rose Shampoo, Silky Smooth Conditioner, and the deep-repair Hair Mask.",
  ...
  ar: {
    ...
    prod_trio_name: "عرض ثلاثي العناية بالشعر",
    prod_trio_desc: "الثلاثي المثالي لشعر رائع. يشمل شامبو الورد الناعم والبلسم الحريري وماسك الشعر للإصلاح العميق.",
